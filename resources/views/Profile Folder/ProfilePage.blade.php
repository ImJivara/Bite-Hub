        ...
        @forelse($likedRecipes as $recipe)
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg">
                ...
                <div class="flex items-center p-2">
                    <a href="/profile/{{$recipe->author->id}}"><img src="{{ asset('imgs/3.jpg') }}" alt="User profile" class="w-12 h-12 rounded-full mr-2"></a>
                    <div>
                        <a href="/profile/{{$recipe->author->id}}"><p class="font-semibold">{{ Auth::user()->username }}</p></a>
                ...
                <!-- Post Image -->
                <a href="/Recipe/{{$recipe->id}}"><img src="{{asset('storage/' . $recipe->thumbnail)}}" alt="{{ $recipe->RecipeName }}"
