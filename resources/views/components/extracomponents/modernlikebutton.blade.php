...
<style>
    ...
    .modern-like-button-recipe {
        display: none;
    }

    .modern-like-button-recipe:checked + label svg {
    ...
    .modern-like-button-recipe + label .action {
        position: relative;
        overflow: hidden;
        display: grid;
    }

    .modern-like-button-recipe + label .action span {
        grid-column-start: 1;
        grid-column-end: 1;
        grid-row-start: 1;
        grid-row-end: 1;
    ...
    .modern-like-button-recipe + label .action span.option-1 {
        transform: translate(0px, 0%);
        opacity: 1;
    }

    .modern-like-button-recipe:checked + label .action span.option-1 {
        transform: translate(0px, -100%);
        opacity: 0;
    }

    .modern-like-button-recipe + label .action span.option-2 {
        transform: translate(0px, 100%);
        opacity: 0;
    }

    .modern-like-button-recipe:checked + label .action span.option-2 {
        transform: translate(0px, 0%);
        opacity: 1;
    }
</style>

<input class="modern-like-button-recipe" type="checkbox" id="like-btn-{{ $recipeId }}" {{ $IsLiked ? 'checked' : '' }}>
