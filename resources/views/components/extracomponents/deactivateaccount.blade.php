<div id="deleteAccountModal" class="modal hidden">
  <div class="card">
      <div class="header">
          ...
          <div class="actions">
              <button id="confirmDeleteBtn" class="deactivate" type="button" onclick="deleteAccount()">Deactivate</button>
              <button id="cancelDeleteBtn" class="cancel" type="button">Cancel</button>
          </div>
      </div>
  </div>
</div>
